...
public class DragableStartX : MonoBehaviour
{
    private Camera cam;
    private bool held;
    ...
    void Update()
    {
        if (held)
        {
            ...
            fullDragableTransform.position = new Vector3(worldPosition.x, sphereDragable.GetPlanePosition(), fullDragableTransform.position.z);
        }
    }
